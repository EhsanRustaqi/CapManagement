...
namespace CapManagement.Shared.DtoModels.DriverDtoModels
{
    public class CreateDriverDto
    {
        ...
        //// Optional: Include contract IDs only if needed in DTO
        //[JsonPropertyName("contractIds")]
        //public List<Guid> ContractIds { get; set; } = new List<Guid>();

        //// Optional: Include active status if you want to show it to clients
